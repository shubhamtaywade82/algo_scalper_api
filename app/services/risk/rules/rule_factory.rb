    ...
    class RuleFactory
      def self.create_engine(risk_config: {})
        rules = [
          ...
          Risk::Rules::SmcNavigatorRule.new(config: risk_config.dig(:exits, :smc_navigator_exit)),
          Risk::Rules::TimeBasedExitRule.new(config: risk_config.dig(:exits, :time_based)),
