          ...
          user_prompt = if force_stop
                          ...
                          if ltp_value
                            'STOP CALLING TOOLS IMMEDIATELY. You have reached maximum iterations or ' \
                              ...
                              '3) Entry Strategy, 4) Exit Strategy, 5) Risk Management. ' \
                          ...
                          'CRITICAL: You have already received option chain data AND LTP data in previous ' \
                            ...
                            '(SL/TP based on ACTUAL premium percentages using the actual premium value ' \
                            'from option chain - include DELTA calculations using the actual delta value ' \
                            'from option chain), 5) Risk Management (calculate using actual premium ' \
                            'values and actual lot_size from option chain). DO NOT call any more tools - ' \
                            'provide your analysis immediately.'
