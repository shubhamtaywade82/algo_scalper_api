...
# docker run -d -p 80:80 -e RAILS_MASTER_KEY=<value from config/master.key> --name algo_scalper_api algo_scalper_api
...
# Node/Yarn assets (Rails 8 still can have assets)
