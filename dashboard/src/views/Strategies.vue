...
const indicesList = computed(() => {
  ...
  return Object.values(indices.value).filter(i => i && i.key)
})
</script>
...
<template>
  <div class="space-y-6">
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
      <div v-for="idx in indicesList" :key="idx.key" class="glass glass-hover p-6 rounded-2xl flex flex-col gap-4 group overflow-hidden relative min-h-[160px]">
