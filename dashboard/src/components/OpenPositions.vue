...
const props = defineProps({
  ...
  wsStale: { type: Boolean, default: true }
})
// ... existing computed and functions if still needed in parent ...
// Actually, inr, pnlClass, sign, formatDuration, dirIcon are now in PositionRow
