...
async function resetDrawdown() {
  ...
  try {
    ...
    if (data.success) {
      ...
      // The dashboard will refresh via polling or WebSocket
    } else {
    ...
    <div class="glass glass-hover p-5 rounded-2xl relative overflow-hidden group border-l-4 border-primary-500/50">
      ...
      <div class="flex flex-col relative z-10">
        ...
        <div class="flex items-center justify-between gap-2 mt-4">
          <div v-if="stats.is_blocked" class="flex items-center gap-2">
          ...
          <span v-else class="text-[9px] font-black text-emerald-400 uppercase tracking-widest flex items-center gap-1">
