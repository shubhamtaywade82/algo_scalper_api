...
function SidebarToggle(props) {
  return (
    ...
    >
      <svg
        class={`w-5 h-5 transition-transform duration-300 ${props.collapsed ? '' : 'rotate-180'}`}
  ...
  return (
    <div class="sticky top-0 z-50">
      <header class="relative glass border-b border-white/5 px-6 py-2.5 flex items-center justify-between gap-4">
        ...
        <div class="flex items-center gap-5 text-[10px] shrink-0">
          <div
            class="hidden lg:flex items-center gap-2 group cursor-help"
          ...
          <div class="hidden lg:flex items-center gap-2 group cursor-help">
          ...
          <div class={`flex items-center gap-2 px-3 py-1.5 rounded-lg border transition-all duration-500 whitespace-nowrap ${props.connected ? 'bg-emerald-500/10 border-emerald-500/20 text-emerald-400' : 'bg-rose-500/10 border-rose-500/20 text-rose-400'}`}>
