...
export default function PositionRow(props) {
  ...
  return (
    ...
    >
      ...
      <td class="px-4 py-5 text-right text-gray-400 text-data font-medium">
        <AnimatedNumber value={pos().quantity} integer decimals={0} />
      </td>
      <td class="px-4 py-5 text-right text-gray-500 text-data text-xs">
      ...
      <td class="px-4 py-5 text-right text-data font-bold">
