...
export default function CalibrationPanel(props) {
  const calibration = createMemo(() => props.data?.calibration)
    ...
    <Show when={calibration()}>
      <div class="glass rounded-2xl p-6 glass-hover">
        ...
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-4">
          <Show when={calibration().ce}>
            <div class="rounded-xl p-5 bg-white/[0.02] border-l-[3px] border-l-emerald-400">
          ...
          <Show when={calibration().pe}>
            <div class="rounded-xl p-5 bg-white/[0.02] border-l-[3px] border-l-rose-400">
