...
#
# Example:
#   Console::SmcHelpers.fetch_candles_with_history(instrument, interval: "60", target_candles: 60)
...
module Console
  module SmcHelpers
    ...
    def fetch_candles_with_history(instrument, interval:, target_candles:, delay_seconds: 1.0)
      ...
      Rails.logger.error("[Console::SmcHelpers] Failed to fetch candles: #{e.class} - #{e.message}")
      nil
    end
